...
import { X, MessageCircle, ExternalLink, Bell, Sparkles } from 'lucide-react';
...
const NotificationPanel: React.FC<NotificationPanelProps> = ({ isOpen, onClose, dynamicNotifications = [] }) => {
    return (
        <>
            {isOpen && (
                <div 
            ...
            <div className={`
                fixed top-0 right-0 h-full w-[320px] bg-white z-[70] shadow-2xl border-l border-gray-100 transform transition-transform duration-300
                        ...
                        <div key={index} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm relative group">
                            ...
                            <div className="flex items-start gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <span className="text-[10px] text-gray-400 font-medium">Acabou de chegar</span>
                                </div>
                            </div>
                            <p className="text-sm text-gray-600 leading-relaxed mb-3">{notif.message}</p>
                            {notif.link && (
                                <a href={notif.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-xs font-bold text-white bg-blue-600 px-4 py-2 rounded-xl hover:bg-blue-700 w-full justify-center">
                    ...
                    <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm relative group">
                        ...
                        <div className="flex items-start gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <span className="text-[10px] text-gray-400 font-medium">Sempre ativo</span>
                            </div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-3">Novidades nos grupos de whatsapp e telegram!</p>
                        <a href="https://chat.whatsapp.com/FrMfiOjv0bz8AFRUgfcvSb" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-xs font-bold text-white bg-[#25D366] px-4 py-2 rounded-xl w-full justify-center shadow-sm">
